...
let maxWidth = document.getElementsByClassName("post")[0].clientWidth/2 - convertRemToPixels(5.5);
let maxHeight = document.getElementsByClassName("post")[0].clientHeight - convertRemToPixels(4);
...
window.addEventListener("resize", () => {
  maxWidth = document.getElementsByClassName("post")[0].clientWidth/2 - convertRemToPixels(3.5);
  maxHeight = document.getElementsByClassName("post")[0].clientHeight - convertRemToPixels(4);
  for(let element of imgs){
